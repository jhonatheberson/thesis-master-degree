#ifndef RTW_HEADER_secorderpid2nd_acc_private_h_
#define RTW_HEADER_secorderpid2nd_acc_private_h_
#include "rtwtypes.h"
...
secorderpid2nd_acc_rt_TDelayInterpolate ( real_T tMinusDelay , real_T tStart
