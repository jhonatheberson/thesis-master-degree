function melhor_individuo=gapid(M,C,K,B,d,tau,w,Ms)
...
%         L=L_ponto_a_ponto(M,C,K,B,tauf,taug,w,(k0+V*nova_populacao(a,:)')');
...
% L=L_ponto_a_ponto(M,C,K,B,tauf,taug,w,(k0+V*nova_populacao(1,:)')');
...
%L=Lpid(M,C,K,B,d,tau,w,k(1,1:3));
%L=L_ponto_a_ponto(M,C,K,B,tauf,taug,w,k);
